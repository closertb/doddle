...
export default class Condition {
    constructor(properties) {
        ...
        if (booleanOperator) {
            ...
            if (_properties.conditionType === 'method') {
                const condition = _properties;
                if (!isFunction(condition.method))
                    throw new Error(`Method Condition: constructor "method" property must be function, but got ${typeof condition.method}`);
                this.isMethod = true;
            ...
            const condition = _properties;
            if (!Object.prototype.hasOwnProperty.call(condition, 'fact'))
     ...
     */
    evaluate(almanac, operatorMap, context) {
        if (this.isMethod) {
